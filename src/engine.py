...
def train_fn(
    ...
    for step, batch in enumerate(tk0):
        ...
        tk0.set_postfix(Epoch=epoch, train_loss=losses.avg, train_loss_frame=losses_frame.avg, train_loss_clip=losses_clip.avg)
...
def valid_fn(model, valid_loader, thresholder):
    ...
    for _, batch in enumerate(tk0):
        ...
        tk0.set_postfix(valid_loss=losses.avg, valid_loss_frame=losses_frame.avg, valid_loss_clip=losses_clip.avg)
